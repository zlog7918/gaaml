...
mark__test_cr_net_from_ind=pytest.mark.parametrize(
  ('input_output', 'gens_strs', 'categorial', 'exp_batch', 'exp_epoch', 'exp_optimalizer_type', 'exp_activation_types', 'exp_weight_shapes'),
  [
    ((2, 4), (
      '0000001  0101000111  0010111011  1  111100000011  1100110100  0101010110',
      '1101001001  0011101110',
      '10 01 11',
    ), False, 821, 343, krs.optimizers.Adam, [
    ...
    ((2, 4), (
      ...
      '1101001001  0011101110',
      '10 01 11',
    ), True, 821, 343, krs.optimizers.Adam, [
      krs.activations.sigmoid, # 2
      krs.activations.tanh, # 1
    ...
    ((50, 99), (
      ...
      '1101001001  0011101110',
      '10 00 11',
    ), False, 789, 821, krs.optimizers.Adam, [
      krs.activations.sigmoid, # 2
    ...
    ((5, 4), (
      ...
      '1101001001  0011101110',
      '10 01 11',
    ), False, 596, 154, krs.optimizers.SGD, [
      krs.activations.sigmoid, # 2
      krs.activations.tanh, # 1
      krs.activations.leaky_relu, # 3
      krs.activations.sigmoid, # 2
    ...
    ((5, 4), (
      ...
      '1101001001  0011101110',
      '10 01 11',
    ), True, 596, 154, krs.optimizers.SGD, [
      krs.activations.sigmoid, # 2
      krs.activations.tanh, # 1
      krs.activations.leaky_relu, # 3
      krs.activations.softmax, # last is replaced with softmax
    ...
    ), False, 821, 821, krs.optimizers.SGD, [
      krs.activations.relu, # 0
    ]*129, [
      (2, 724), # i->h_1
      (724,), # +w_1^
