...
with particular emphasis on the \acrshort{MLP} architecture.
...
In the practical section, the project requirements
were analyzed and based on them, \acrshort{GAAML},
the Python library, was designed and described
that enables the automatic selection
of a~satisfactory \acrshort{MLP} network structure.
The developed solution enables automatic
...
finds solutions that are better than those
selected by purely stochastic method,
