...
Jest to charakterystyczne dla sieci MLP,
...
\begin{figure}
  \centering
  \subcaptionbox{FNN\label{subfig:fnn}}{%
  ...
  \hspace{2cm}
  \subcaptionbox{FNN - MLP\label{subfig:fnn_mlp}}{%
...
\begin{figure}
  ...
  \caption{
    Trzy płaszczyzny
    z~\citebook[cite={rys. 5.2}]{Goodfellow-et-al-2016}
...
wzięte do optymalizacji tylko sieci MLP.
Kod genetyczny przedstawiony jest
jako trzy liczby oraz dwie listy,
co zostało uwidocznione na \cref{tab:domashova2021}.
\begin{table}
  \centering \begin{tabularx}{0.9\textwidth}{%
    >{\hsize=\dimexpr2\hsize+2\tabcolsep}XXXXXXX%
  }
    \hline
...
optymalnej architektury sieci MLP przy
