...
\begin{figure}
  ...
  \subcaptionbox{\gls{FNN}\label{subfig:fnn}}{%
    \immediate\write18{%
      sh ./img/drawio_to_pdf img/02_img/fnn/fnn.drawio
    }
    \includegraphics[
      trim={0 0 0 0},
      height=6.5cm,
      clip,
    ]{img/02_img/fnn/fnn.drawio.pdf}
  }
  \hspace{2cm}
  \subcaptionbox{\gls{MLP}\label{subfig:fnn_mlp}}{%
    \immediate\write18{%
      sh ./img/drawio_to_pdf img/02_img/fnn/fnn_mlp.drawio
    }
    \includegraphics[
      trim={0 0 0 0},
      height=6.5cm,
      clip,
    ]{img/02_img/fnn/fnn_mlp.drawio.pdf}
  }
  \caption{
...
\begin{table}
  \centering
  \input{tab/tab_02/domashova2021.tex}
  \caption{
