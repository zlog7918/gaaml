...
\begin{figure}
  ...
  \caption{
    Trzy płaszczyzny
    z~\cite[rys. 5.2]{Goodfellow-et-al-2016}
    ukazujące możliwe zachowania
    dla modeli zbyt prostych w~stosunku
    do danych (po lewej), zbyt złożonych (po prawej)
    oraz sieci o~złożoności odpowiadającej
