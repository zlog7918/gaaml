...
\begin{figure}
  ...
  \caption{
    Trzy płaszczyzny
    z~\authorcite[rys. 5.2]{Goodfellow-et-al-2016}
...
\begin{figure}
  ...
  \caption{
    Klasyczny przebieg algorytmu genetycznego
    opisany w~\authorcite{eiben2015evolutionary}.
...
Przykładowo w~\authorcite[481]{miller1989designing}
zostaje przedstawiony opis zawierający
połączenia między neuronami
ze stałą liczbą neuronów.
Natomiast w~\authorcite[268]{domashova2021optimal}
...
zostały przedstawione w~\authorcite{miller1989designing},
