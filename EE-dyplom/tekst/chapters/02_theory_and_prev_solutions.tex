...
którego elementy są omawiane w~poniższych podrozdziałach.
\begin{figure}
  ...
  \caption{
    Klasyczny przebieg algorytmu genetycznego
    opisany w~\cite{eiben2015evolutionary}.
