...
\subsection{Krzyżowanie - część binarna}
W~przypadku części binarnej zostanie
użyte krzyżowanie jednopunktowe,
gdzie losowo zostanie wybrany punkt podziału
i~części kodu genetycznego zostaną zamienione
między dwoma rodzicami.
...
% gdzie losowo są wybrane punkty podziału w~obu listach\,\sscite{hutt2007varlengthcrossover}.
...
nastąpi podział elementów w~drugiej liście.
...
$$
  \mbox{fit}\left(d, n\right)=\frac{1}{1-d\left(1+0.2\frac{n-1}{n_{\max}-1}\right)}
