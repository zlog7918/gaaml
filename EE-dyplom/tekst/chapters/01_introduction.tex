...
\Cref{chap:summary} stanowi podsumowanie niniejszej pracy, zawiera informacje czy cel projektu został osiągnięty i co zostało wykonane, odpowiada na pytania badawcze oraz przedstawia dalsze pola rozwoju stworzonej biblioteki.
