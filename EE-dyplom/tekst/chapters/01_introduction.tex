...
o~jakości lepszej niż rozwiązania wytworzone
przez metodę czysto stochastyczną.
...
\Cref{chap:result_and_restricts} przedstawia analizę
wyników z~poprzedniego rozdziału i~na
ich podstawie przedstawia ograniczenia.

\Cref{chap:summary} stanowi podsumowanie niniejszej pracy,
zawiera informacje czy cel projektu
został osiągnięty i~co zostało wykonane,
odpowiada na pytania badawcze oraz przedstawia
dalsze pola rozwoju stworzonej biblioteki.
