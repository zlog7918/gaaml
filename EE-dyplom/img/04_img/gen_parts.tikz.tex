\begin{tikzpicture}[
  ...
  \node[
    umlclass,
    below left=1.5cm and -3.2cm of Ind,
  ] (SI) {%
  ...
  \node[
    umlclass,
    below right=1.5cm and -3.2cm of Ind,
  ] (LI) {%
  ...
  \draw[inheritance]
    ...
    -- node[
      ...
      {\textless}tuple{\textless}int, lcpt, lcpt{\textgreater},
    }\\\texttt{%
      tuple{\textless}MNSI, MNLI, MNLI{\textgreater}{\textgreater}%
    }}
    (Ind.south)
  ;
