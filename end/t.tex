...
\begin{minted}{text}
  ...
  Losowanie punktu podziału rodzica 1 (z zakresu 0-12): 3
  Pełnych elementów rodzica 1: 3/2=1.5 -> 1
  Liczba bitów z następnego elementu rodzica 1: 3%2=1 -> 1
  Długość zapewniona dla dziecka 1: 1+1=2 -> 2
  Długość zapewniona dla dziecka 2: 6-1=5 -> 5

  Losowanie punktu podziału rodzica 2
    (z zakresu 0-4 lub 1-5 jeżeli liczba bitów rodzica 1, to 0): 3
