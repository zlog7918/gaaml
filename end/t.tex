...
$\displaystyle
  ...
  k_r=\begin{cases}
    ...
    n_{r_2}-\left(l_{\min}-l_{p_{c_1}}+l_{p_b}\right)
      &, l_{p_{c_1}}<l_{\min}\\
  \end{cases}\\
  p_{r_2}=R\left(p_r, k_r\right) + l_b
$
...
$\displaystyle
  ...
  n_{c_1}=\begin{cases}
    \frac{p_{r_1}+\left(n_{p_2}-p_{r_2}\right)}{e_s}=
      \frac{n_{p_2}+\left(p_{r_1}-p_{r_2}\right)}{e_s}=
      \frac{n_{p_2}+{\Delta p_r}}{e_s}
        &, \frac{n_{p_2}+{\Delta p_r}}{e_s} \le e_s l_{\max}\\
    l_{\max}
      &, \frac{n_{p_2}+{\Delta p_r}}{e_s}>e_s l_{\max}\\
  \end{cases}\\
  n_{c_2}=\begin{cases}
    \frac{p_{r_2}+\left(n_{p_1}-p_{r_1}\right)}{e_s}=
      \frac{n_{p_1}-\left(p_{r_1}-p_{r_2}\right)}{e_s}=
      \frac{n_{p_1}-{\Delta p_r}}{e_s}
        &, \frac{n_{p_1}-{\Delta p_r}}{e_s} \le e_s l_{\max}\\
    l_{\max}
      &, \frac{n_{p_1}-{\Delta p_r}}{e_s}>e_s l_{\max}\\
  \end{cases}\\
