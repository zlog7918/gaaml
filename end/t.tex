...
\begin{minted}[frame=single]{python3}
  gen=(
    '000000010000010010110001010100010111111111110000110010',
    [64,32,8,16,4],
    [0,1,0,2,1]
  )
\end{minted}
...
\begin{minted}[frame=single]{python3}
  ...
  #   wskaźnik uczenia się (learning rate): 1/2^13-1.0,
  #   liczba epok: 1-1024,
  #   ilość neuronów w warstwach: lista[2-1 073 741 825],
